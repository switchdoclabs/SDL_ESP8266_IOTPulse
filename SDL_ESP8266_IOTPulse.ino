/*
    ...
    Connects Pulse detector to the IBM Cloud IoT using a ESP8266 processor
...
#define DEVICE_ID "IOTPulse-01" // use anything for quickstart or customize to your registered device id
